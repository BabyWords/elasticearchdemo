package com.wujunwen.elasticearchdemo.entity;
...
public class EmployeesDO implements Serializable {
    ...
    public String toString() {
        return "EmployeesDO [empNo=" + empNo + ", birthDate=" + birthDate + ", firstName=" + firstName + ", lastName=" + lastName + ", gender=" + gender + ", hireDate=" + hireDate + "]";
    }
}
